...
import UserSpecificCredentialForm from '@/components/admin/single-user/UserSpecificCredentialForm';
import { useUserSearch } from '@/hooks/admin/useUserSearch';

const SingleUserCredentialManagement = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-1">Single User Manage Credentials</h1>
        <p className="text-gray-600">
          Search for a user and manage their specific credentials
        </p>
      </div>
...
export default SingleUserCredentialManagement;
