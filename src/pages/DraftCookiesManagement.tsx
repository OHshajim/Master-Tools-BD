...
import { DraftCookiesList } from '@/components/admin/draft/DraftCookiesList';

const DraftCookiesManagement = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-1">Draft Cookie Platforms</h1>
        <p className="text-gray-600">
          Hide specific cookie platforms from users' access pages
        </p>
      </div>
...
export default DraftCookiesManagement;
